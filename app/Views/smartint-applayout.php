									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td><a href="<?php echo ASSETS_URL; ?>/misc/login" class="btn btn-default btn-xs" data-action="userLogout" data-logout-msg="Your message here..."> action </a></td>
											</tr>
											<tr>
												<td>
													<code>
								...
								<div class="padding-gutter">
									<div style="background: #f1f1f1;border-radius:3px;overflow: hidden">
										<div style="width: 100%;height: auto;background:#ddd;font-size:11px;font-weight: bold;padding:13px 10px">
											<img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="SmartAdmin" style="width:75px;">
										</div>
