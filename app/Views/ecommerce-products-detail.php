									...
									<div id="myCarousel-2" class="carousel slide">
										...
										<div class="carousel-inner">
											...
											<div class="item active">
												<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/detail-1.png" alt="">
											</div>
											<!-- Slide 2 -->
											<div class="item">
												<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/detail-2.png" alt="">
											</div>
											<!-- Slide 3 -->
											<div class="item">
												<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/detail-3.png" alt="">
											</div>
										</div>
										...
										<div class="tab-pane fade" id="reviews">
											...
											<div class="chat-body no-padding profile-message">
												<ul>
													...
													<li class="message">
														<img src="<?php echo ASSETS_URL; ?>/img/avatars/2.png" class="online">
														<span class="message-text">
															<a href="javascript:void(0);" class="username">
																Aragon Zarko
																<span class="badge">Purchase Verified</span>
