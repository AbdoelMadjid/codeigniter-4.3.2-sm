			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-collapse.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-hidden.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-menutop.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-collapse-minified.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-rtl.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<br>
						<br>
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/layout-rtl-menutop.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<!-- end row -->
