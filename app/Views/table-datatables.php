...
<div id="main" role="main">
	...
	$breadcrumbs[$page_nav["tables"]["title"]] = "";
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		*/
		...
		// custom toolbar
		$("div.toolbar").html('<div class="text-right"><img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
		// Apply the filter
