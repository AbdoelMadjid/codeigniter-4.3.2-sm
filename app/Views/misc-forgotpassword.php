...
<header id="header">
	...
	<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<?php echo APP_URL; ?>/miscellaneous/misc_register" class="btn btn-danger">Creat account</a> </span>
</header>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
				<div class="well no-padding">
					<form action="<?php echo APP_URL; ?>/miscellaneous/misc_login" id="login-form" class="smart-form client-form">
						<header>
							Forgot Password
						</header>
						<fieldset>
							...
							<section>
								...
								<div class="note">
									<a href="<?php echo APP_URL; ?>/miscellaneous/misc_login">I remembered my password!</a>
								</div>
							</section>
						</fieldset>
						<footer>
