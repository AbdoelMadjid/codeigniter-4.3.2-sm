...
<div id="main" role="main">
	...
	//$breadcrumbs["Smart Chat Api"] => "http://url.com";
	//$breadcrumbs[] = "Smart Chat Api";
	...
	<div id="content">
				...
				-->
						...
						<div>
							...
							<div class="widget-body">
								...
								<img src="<?php echo ASSETS_URL; ?>/img/demo/chat.png" alt="Chat" class="bordered img-responsive" style="margin-bottom:10px;">
								<br>
						...
						<div>
							...
							<div class="widget-body">
								...
								<div style="background: #f8f8f8; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;">
									<pre style="margin: 0; line-height: 125%">      	<span style="color: #000000">options</span><span style="color: #ce5c00; font-weight: bold">:</span> <span style="color: #000000; font-weight: bold">{</span>
      ...
      <span style="color: #000000; font-weight: bold">});</span>
								...
								<div style="background: #f8f8f8; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;">
									<pre style="margin: 0; line-height: 125%">      <span style="color: #000000; font-weight: bold">...</span>
