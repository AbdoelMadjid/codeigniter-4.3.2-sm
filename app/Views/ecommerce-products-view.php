						...
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/1.png" alt="194x228" class="img-responsive">
									<span class="tag2 hot">
										HOT
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/2.png" alt="194x228" class="img-responsive">
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/3.png" alt="194x228" class="img-responsive">
									<span class="tag2 hot">
										HOT
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/4.png" alt="194x228" class="img-responsive">
									<span class="tag2 sale">
										Sale
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/5.png" alt="194x228" class="img-responsive">
									<span class="tag2 sale">
										Sale
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/7.png" alt="194x228" class="img-responsive">
									<span class="tag2 sale">
										Sale
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/8.png" alt="194x228" class="img-responsive">
									<span class="tag2 sale">
										Sale
									</span>
								</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					...
					<div class="product-content product-wrap clearfix">
						<div class="row">
							<div class="col-md-5 col-sm-12 col-xs-12">
								<div class="product-image">
									<img src="<?php echo ASSETS_URL; ?>/img/demo/e-comm/9.png" alt="194x228" class="img-responsive">
									<span class="tag2 sale">
										Sale
									</span>
								</div>
