...
<div id="main" role="main">
	...
	$breadcrumbs["Forum Layout"] = APP_URL . "/views-forum.php";
			...
			<div class="col-sm-12">
				<div class="well">
					<table class="table table-striped table-forum">
						<thead>
							<tr>
								<th colspan="2"><a href="views_forum"> Projects </a> > Business Requirement Docs</th>
						...
						<tbody>
							...
							<tr class="warning">
								...
								<td>
									<h4><a href="views_forum_post">
											Welcome message
										</a>
										<small><a href="views_profile">John Doe</a> on <em>January 1, 2014</em></small>
									</h4>
								</td>
