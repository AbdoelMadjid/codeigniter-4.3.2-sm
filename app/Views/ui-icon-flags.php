						...
						<div>
							...
							<div class="widget-body">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
										<img class="flag flag-ci" src="<?php echo ASSETS_URL; ?>/img/blank.gif" alt="Côte d'Ivoire"> Côte d'Ivoire
									</div>
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
									...
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
										<img class="flag flag-re" src="<?php echo ASSETS_URL; ?>/img/blank.gif" alt="Réunion"> Réunion
									</div>
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
								...
								<div class="row">
									...
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
										<img class="flag flag-cw" src="<?php echo ASSETS_URL; ?>/img/blank.gif" alt="Curaçao"> Curaçao
									</div>
									<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
