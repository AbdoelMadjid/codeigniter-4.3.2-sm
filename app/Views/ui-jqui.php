		...
		<div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6">
				...
				<div class="well well-sm well-light">
					...
					<input type="text" class="slider slider-primary" id="g1" value="" data-slider-max="500" data-slider-value="185" data-slider-selection="before" data-slider-handle="round">
					<input type="text" class="slider slider-success" id="g2" value="" data-slider-max="1000" data-slider-step="1" data-slider-value="[150,760]" data-slider-handle="squar">
...
data-slider-handle="round" <span class="text-muted"> // round or square</span> </pre>
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
				...
				<div class="well well-sm well-light">
					...
					<input class="form-control" placeholder="Type something..." type="text" data-autocomplete='[
			"ActionScript",
			"AppleScript",
			"Asp",
			"BASIC",
