...
<div id="main" role="main">
	...
	$breadcrumbs[$page_nav["smartint"]["title"]] = "";
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/ajaxversion.png" alt="Ajax Version" style="margin-left:-40px; width: 150px; margin-top:20px">
						...
						<a href="javascript:void(0);" class="btn btn-default btn-lg btn-block btn-primary disabled txt-color-white">Ajax Demo</a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<!-- your contents here -->
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/angularversion.png" alt="AngularJS Version" style="margin-left:-40px; width: 150px; margin-top:20px">
						...
						<a href="javascript:void(0);" class="btn btn-default btn-lg btn-block btn-danger">Angular Demo <i class="fa fa-long-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<!-- your contents here -->
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/htmlversion.png" alt="HTML Version" style="margin-left:-40px; width: 150px; margin-top:20px">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<!-- your contents here -->
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/phpversion.png" alt="PHP Version" style="margin-left:-40px; width: 150px; margin-top:20px">
						...
						<a href="javascript:void(0);" class="btn btn-default btn-lg btn-block btn-primary">Currently viewing... <i class="fa fa-long-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<!-- your contents here -->
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/dotnetversion.png" alt="PHP Version" style="margin-left:-40px; width: 150px; margin-top:20px">
						...
						<a href="javascript:void(0);" class="btn btn-default btn-lg btn-block bg-color-purple txt-color-white">MVC Demo <i class="fa fa-long-arrow-right"></i></a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<!-- your contents here -->
					<div class="jumbotron padding-10 text-center bg-color-white">
						<img src="<?php echo ASSETS_URL; ?>/img/versions/reactversion.png" alt="PHP Version" style="margin-left:-40px; width: 150px; margin-top:20px">
						...
						<a href="javascript:void(0);" class="btn btn-default disabled btn-lg btn-block bg-color-darken txt-color-white">Not yet available...</a>
					</div>
				</div>
			</div>
			<!-- end row -->
