			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-glass.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-google.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-pixel.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-dark.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-default.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
				<div class="col-sm-6">
					<!-- your contents here -->
					<div class="well text-center">
						...
						<img src="<?php echo ASSETS_URL; ?>/img/demo/layout-skins/skin-ultralight.png" class="img-responsive center-block" style="box-shadow: 0px 0px 3px 0px #919191;">
					</div>
				</div>
			</div>
			<!-- end row -->
